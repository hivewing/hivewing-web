...
(defroutes app-routes
  ...
  (hw-route GET (paths/hive-processing-new-choose-stage-path ":hive-uuid" ) hive/processing-new-choose-stage)
  (hw-route GET (paths/hive-processing-new-stage-path ":hive-uuid" ":stage-name") hive/processing-new-stage)
  (hw-route POST (paths/hive-processing-create-stage-path ":hive-uuid" ":stage-name") hive/processing-create-stage)
  (hw-route POST (paths/hive-processing-delete-stage-path ":hive-uuid" ":stage-uuid") hive/processing-delete-stage)
